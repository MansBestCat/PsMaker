...
import { SmokePlume } from "../ParticleSystems/SmokePlume";
import { Utility } from "../Utilitites/Utility";

export class SmokePlumeScene {
    ...
    go(data: Data, cameraManMain: CameraManMain) {
        ...
        this.particleSystem = new SmokePlume({
            maxEmitterLife: undefined,
            frequency: 128 // every 8th tick
        }, data);
        (this.particleSystem as SmokePlume).init();
        ...
        const ps = this.particleSystem as SmokePlume;
