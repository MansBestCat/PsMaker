...
export class Corona extends ParticleSystemBase {
    ...
    constructor(params: any, public data: Data) {
        ...
        this.colorSpline.addPoint(0.0, new Color(0x70aeff));
        this.colorSpline.addPoint(1.0, new Color(0x1b60bb));
        ...
        this.velocitySpline.addPoint(0.0, 10.0);
        this.velocitySpline.addPoint(0.25, 4.0);
